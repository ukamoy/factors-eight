...
def get_dv(start = 20170101,end = 20180101): 
    ...
    #define
    factor_list  = ['surplus_rsrv','total_share','undistributed_profit',
                    'close_adj','volume','AroonUp','VSTD20','Skewness']
...
from Tamplate import RetainedEarningsPS,Aroon_up,VSTD_20,SharpeRatio_60,Skewness_20

for f in ['RetainedEarningsPS','Aroon_up','VSTD_20','SharpeRatio_60','Skewness_20']:
